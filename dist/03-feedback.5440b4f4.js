...
const formEmail = document.querySelector(".feedback-form");
const email = document.querySelector('[name = "email"]');
const message = document.querySelector('[name = "message"]');
const STORAGE_KEY = "feedback-form-state";
formEmail.addEventListener("input", (0, _lodashThrottleDefault.default)(onInputForm, 500));
formEmail.addEventListener("submit", onSubmitForm);
let dataInput = JSON.parse(localStorage.getItem(STORAGE_KEY)) || {};
onGetLocalStorage();
